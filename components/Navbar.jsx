...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 h-20 px-[5%] flex items-center justify-between transition-colors duration-300 ${
          scrolled || open ? 'bg-green-mid/95 backdrop-blur-sm' : 'bg-transparent'
        }`}
      >
        {/* Logo */}
